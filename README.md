...
- Bei Monaten wird auf den letzten vorhandenen Tag begrenzt: 31. Januar → 28./29. Februar → 28./29. März. Keine feste „letzter Monatstag“-Regel in Version 1.
...
Die Funktionen sind für diese kleine erste Version in drei verständlichen JavaScript-Dateien gebündelt. Bei späteren Updates die Cache-Versionsnummer in `sw.js` erhöhen und alle App-Tabs schließen, damit die neue Version aktiv wird. Nutzerdaten liegen getrennt vom Datei-Cache.
