...
const CACHE='boruemir-shell-v2';
const FILES=['./','./index.html','./manifest.webmanifest','./assets/css/styles.css','./assets/js/timeline.js','./assets/icons/logo.png','./assets/js/core.js','./assets/js/app.js','./assets/js/install.js','./assets/icons/favicon.svg','./assets/icons/icon-192.png','./assets/icons/icon-512.png','./assets/icons/icon-maskable-512.png','./assets/icons/apple-touch-icon.png'];
